...
class zvonok(models.Model):
    ...
    raion=models.CharField('Район', choices=raion_choise, max_length=20 , default='Неважно', blank=False)
    ...
    prim = models.TextField('Первичная информация:', blank=True)
    coment = models.TextField('Коментарий по проделанной работе', blank=True)
    ...
    prezvonit = models.DateTimeField(verbose_name='Перезвонить: ', blank=True, )#default=datetime.now())
